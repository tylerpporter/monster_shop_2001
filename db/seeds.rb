...
ItemOrder.create(item: dog_item1, order: order1, price: dog_item1.price, quantity: 1500)
ItemOrder.create(item: dog_item2, order: order1, price: dog_item2.price, quantity: 1200)
ItemOrder.create(item: dog_item3, order: order1, price: dog_item3.price, quantity: 900)
...
ItemOrder.create(item: art_item1, order: order1, price: art_item1.price, quantity: 1400)
ItemOrder.create(item: art_item2, order: order2, price: art_item2.price, quantity: 1100)
ItemOrder.create(item: art_item3, order: order2, price: art_item3.price, quantity: 800)
ItemOrder.create(item: art_item4, order: order2, price: art_item4.price, quantity: 500)
ItemOrder.create(item: art_item5, order: order2, price: art_item5.price, quantity: 200)
ItemOrder.create(item: bike_item1, order: order2, price: bike_item1.price, quantity: 1300)
ItemOrder.create(item: bike_item2, order: order2, price: bike_item2.price, quantity: 1000)
ItemOrder.create(item: bike_item3, order: order2, price: bike_item3.price, quantity: 700)
ItemOrder.create(item: bike_item4, order: order2, price: bike_item3.price, quantity: 100)
ItemOrder.create(item: bike_item5, order: order2, price: bike_item5.price, quantity: 400)
