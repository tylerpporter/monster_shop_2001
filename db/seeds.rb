...
#order
order1 = regular_user.orders.create!(name: "Order1", address: "123 S Order2 way", city: "Whatatown", state: "CA", zip: 98765)
order2 = bike_shop_employee.orders.create!(name: "order2", address: "456 S Order2 way", city: "Whatitown", state: "NY", zip: 12345)
order3 = art_shop_employee.orders.create!(name: "Order3", address: "456 S Order3 way", city: "Whatitown", state: "NY", zip: 12345)
