...
RSpec.describe 'As a registered user, merchant, or admin' do
  ...
  describe 'regular user logout happy path' do
    context 'I am redirected to the welcome / home page of the site' do
      ...
      it 'Any items I had in my shopping cart are deleted' do
        expect(@items_in_cart.empty?).to eql(true)
      end
    end
  end

  describe 'merchant user happy path' do
    context 'I am redirected to the welcome / home page of the site' do
      it 'And I see a flash message that I am logged out' do
  ...
  describe 'admin user happy path' do
    context 'I am redirected to the welcome / home page of the site' do
      it 'And I see a flash message that I am logged out' do
