...
RSpec.describe 'As a merchant employee' do
  before(:each) do
    ...
    @order1.item_orders.create(item: @art_item1, price: @art_item1.price, quantity: 2)
    @order1.item_orders.create(item: @bike_item1, price: @bike_item1.price, quantity: 2)
    @order1.item_orders.create(item: @bike_item2, price: @bike_item2.price, quantity: 3)

    @order2 = @shopper.orders.create(name: "Test", address: "123 S South St", city: "Whatatown", state: "CA", zip: 98765)
    @order2.item_orders.create(item: @bike_item1, price: @bike_item1.price, quantity: 5)
    @order2.item_orders.create(item: @bike_item2, price: @bike_item2.price, quantity: 5)
    @order2.item_orders.create(item: @art_item1, price: @art_item1.price, quantity: 4)
