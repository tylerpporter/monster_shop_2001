  ...
  describe "When I visit the items index page" do
    ...
    it "I can see a section that shows top 5 quanitity purchased and quantity bought of each" do
      ...
      within(".most-popular-items") do
        ...
        expect(page.all(".item")[0]).to have_content("#{dog_item6} - 2000 ordered")
        expect(page.all(".item")[1]).to have_content("#{dog_item3} - 1500 ordered")
        expect(page.all(".item")[2]).to have_content("#{dog_item1} - 1200 ordered")
        expect(page.all(".item")[3]).to have_content("#{dog_item2} - 1100 ordered")
        expect(page.all(".item")[4]).to have_content("#{dog_item7} - 700 ordered")
    ...
    it "I can see a section that shows top 5 quanitity purchased and quantity bought of each" do
      ...
      within(".least-popular-items") do
        ...
        expect(page.all("item")[0]).to have_content("#{dog_item5} - 300 ordered")
        expect(page.all("item")[1]).to have_content("#{dog_item4} - 600 ordered")
        expect(page.all("item")[2]).to have_content("#{dog_item7} - 700 ordered")
        expect(page.all("item")[3]).to have_content("#{dog_item2} - 1100 ordered")
        expect(page.all("item")[4]).to have_content("#{dog_item1} - 1200 ordered")
